...
export const SETPROFFETION = "SETPROFFETION";
export const GETCEO = "GETCEO";
export const GETDEVOPS = "GETDEVOPS";
export const GETDEVELOPERS = "GETDEVELOPERS";

export const SETNAMEOFPROJECT = "SETNAMEOFPROJECT";
export const SETDESCRIPTIONOFPROJECT = "SETDESCRIPTIONOFPROJECT";
// export const GETDESCRIPTIONOFPROJECT = 'GETDESCRIPTIONOFPROJECT'
...
export const SET_CHANGED_TASK = "SET_CHANGED_TASK";
